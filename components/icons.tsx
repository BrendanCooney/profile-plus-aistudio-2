...
export const BriefcaseIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.998a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.97-1.732l5.05-3.44a2.25 2.25 0 012.56 0l5.05 3.44a2.25 2.25 0 01.97 1.732z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21.75v-3.75m0 0V8.25m0 3.75h.008v.008H12v-.008zM12 15h.008v.008H12V15zm0 2.25h.008v.008H12v-.008zM15.75 15h.008v.008h-.008V15zm0 2.25h.008v.008h-.008v-.008zM8.25 15h.008v.008H8.25V15zm0 2.25h.008v.008H8.25v-.008zM3.75 9.75h16.5M4.5 3.75h15A2.25 2.25 0 0121.75 6v2.25H2.25V6A2.25 2.25 0 014.5 3.75z" />
  </svg>
);
